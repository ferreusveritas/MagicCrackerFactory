...
public class Registry {
    ...
    public static final RegistryObject<Block> TOUCH_BUTTON_BLOCK = BLOCKS.register("touch_button", TouchButtonBlock::new);    public static final RegistryObject<TileEntityType<CartographerTileEntity>> CARTOGRAPHER_TILE_ENTITY = TILE_ENTITIES.register("cartographer",
