...
public class CommsThread extends Thread {
	...
	private final ConcurrentMap<Integer, TileWebModem> modems;
	...
	public CommsThread(int port) {
		...
		modems = new ConcurrentHashMap<Integer, TileWebModem>();
		try {
			sel = Selector.open();
		}
		catch (IOException e) {
	 ...
	 */
	public void registerModem(int computerID, TileWebModem modem) {
	 ...
	 */
	public void unregisterModem(int computerID, TileWebModem modem) {
	...
	private boolean processInput(SocketChannel sc) throws IOException {
		...
		if (modems.containsKey(computerIDint)) {
			...
			TileWebModem modem = modems.get(computerIDint);
